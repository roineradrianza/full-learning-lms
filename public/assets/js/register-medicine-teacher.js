...
let vm = new Vue({
    ...
    methods: {
      ...
      loadCountries () {
        this.$http.get(domain + '/public/countries.min.json').then(res => {
          this.countries = res.body.countries
        }, err => {

        })
        this.$http.get(domain + '/public/states.min.json').then(res => {
      ...
      makeGoogleApiCall() {
        ...
        gapi.client.people.people.get({
          ...
          user.meta = app.defaultItem.meta
          user.register_to_course = app.defaultItem.register_to_course
