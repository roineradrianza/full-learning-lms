...
&& !profile_container && !orders_container && !grades_container ">
    ...
    <template v-if="1 == 2">
        ...
        <v-row class="d-flex align-center px-4">
            ...
            <v-col cols="12" md="3" sm="4">
                <v-img src="<?php echo SITE_URL ?>/public/img/flecha.svg" width="80%"></v-img>
            </v-col>
        </v-row>
...
<?php echo new Template('account/parts/private/profile_edit') ?>
<?php echo new Template('account/parts/private/courses') ?>
<?php echo new Template('account/parts/private/orders') ?>
<?php echo new Template('account/parts/private/grades') ?>