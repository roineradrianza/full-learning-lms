      				...
      				<template v-if="previewImage != currentImage && !image_loading">
						...
						<v-img class="grey darken-3 overlay-img d-flex align-center" :src="previewImage" width="100%" max-height="60vw">
						  ...
						  <v-tabs class="mt-n16" fixed-tabs>
						    ...
						    <?php echo new Template('course/edit/tabs/general') ?>
						    </v-tab-item>
						    <v-tab-item class="px-md-14 px-7 py-10">
						    <?php echo new Template('course/edit/tabs/instructors') ?>
						    </v-tab-item>
						    <v-tab-item class="px-md-14 px-7 py-10">
						    <?php echo new Template('course/edit/tabs/curriculum') ?>
						    </v-tab-item>
						    <v-tab-item class="px-md-14 px-7 py-10">
						    <?php echo new Template('course/edit/tabs/FAQ') ?>
						    </v-tab-item>
						    <v-tab-item class="px-md-14 px-7 py-10">
						    <?php echo new Template('course/edit/tabs/setup') ?>
						    </v-tab-item>
						  </v-tabs>
					</v-col>
					<?php echo new Template('course/edit/parts/sidebar') ?>
				</v-row>
