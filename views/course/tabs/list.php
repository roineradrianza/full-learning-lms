<v-tabs v-model="list_tab" fixed-tabs centered show-arrows ref="list_tabs_section">
    ...
    <v-tab-item class="px-3 pt-5" value="users">
        <?php echo new Template('course/tabs/list_tabs/users') ?>
    </v-tab-item>

    <v-tab-item class="px-3 py-10" value="classes">
        <?php echo new Template('course/tabs/list_tabs/classes') ?>
    </v-tab-item>

    <v-tab-item class="px-3 py-10" value="quizzes">
        <?php echo new Template('course/tabs/list_tabs/quizzes') ?>
    </v-tab-item>

    <v-tab-item class="px-3 py-10" value="orders">
        <?php echo new Template('course/tabs/list_tabs/orders') ?>
    </v-tab-item>
