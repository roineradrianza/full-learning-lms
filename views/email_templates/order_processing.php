                                    ...
                                    <tr>
                                        <td style='font-size: 16px; vertical-align: top;'>
                                            ...
                                            <?php if ($payment_method == 'Bank Transfer(Bs)'): ?>
                                              ...
                                              <?php echo new Template('email_templates/order_processing/bs-bank-transfer', $data) ?>
                                            ...
                                            <?php if ($payment_method == 'PagoMovil'): ?>
                                              ...
                                              <?php echo new Template('email_templates/order_processing/pagomovil', $data) ?>

                                            <?php endif ?>

                                            <?php if ($payment_method == 'Zelle'): ?>

                                              <?php echo new Template('email_templates/order_processing/zelle', $data) ?>
