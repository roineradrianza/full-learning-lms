                            ...
                            <v-col cols="12">
                                <v-row>
                                    ...
                                    <template v-if="orders.editedItem.payment_method == 'Zelle'">
                                        <?php echo new Template('admin/parts/order/preview/zelle') ?>
                                    </template>

                                    <template v-else-if="orders.editedItem.payment_method == 'Bank Transfer(Bs)'">
                                        <?php echo new Template('admin/parts/order/preview/bs-bank-transfer') ?>
                                    </template>

                                    <template v-else-if="orders.editedItem.payment_method == 'PagoMovil'">
                                        <?php echo new Template('admin/parts/order/preview/pagomovil') ?>
                                    </template>

                                    <template v-else-if="orders.editedItem.payment_method == 'Paypal'">
                                        <?php echo new Template('admin/parts/order/preview/paypal') ?>
                                    </template>
                                </v-row>
                            </v-col>
                        </v-row>
