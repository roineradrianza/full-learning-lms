                          ...
                          <v-row>
                          	<v-col cols="12">
                                ...
                                <template v-if="payments.editedItem.name == 'Zelle'">
                                  <?php echo new Template('admin/parts/payment/zelle') ?>
                                </template>

                                <template v-else-if="payments.editedItem.name == 'Bank Transfer(Bs)'">
                                  <?php echo new Template('admin/parts/payment/bs-bank-transfer') ?>
                                </template>

                                <template v-else-if="payments.editedItem.name == 'PagoMovil'">
                                  <?php echo new Template('admin/parts/payment/pagomovil') ?>
                                </template>
