	      <v-row class="px-16">
	      	<v-col class="pr-12 mb-n8" cols="12">
		      	<h3 class="text-h4 grey--text mb-6">Cursos avalados</h3>
		      	<v-divider></v-divider>
	      	</v-col>
		      <v-col cols="12" md="6" sm="12">
		      		<v-card :loading="loading" class="my-12 course-card" max-width="95%">
						    ...
						    <v-img width="100vw" class="align-end" src="/public/img/cursos/cursos.png" >
						    ...
						    <v-avatar class="teacher-course-avatar">
						      <img src="/public/img/avatar/profesores1.png" width="20px" height="20px" alt="John">
						    </v-avatar>
