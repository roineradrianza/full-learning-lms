<v-row class="d-flex align-center" style="min-height: 83vh;">
    ...
    <v-col class="mb-16" cols="10" md="8" offset-md="2" offset="1">
                        ...
                        <v-col cols="12">
                            <v-row>
                                ...
                                <template v-else-if="order.payment_method == 'Bank Transfer(Bs)'">
                                    <?php echo new Template('checkout/preview/bs-bank-transfer') ?>
                                </template>

                                <template v-else-if="order.payment_method == 'PagoMovil'">
                                    <?php echo new Template('checkout/preview/pagomovil') ?>
                                </template>
                            </v-row>
                        </v-col>
                    </v-row>
        ...
        <v-row class="d-flex justify-center" v-else>
            <v-col cols="12" md="8">
                <v-img src="<?php echo SITE_URL ?>/public/img/order-not-fund.svg"></v-img>
            </v-col>
            <v-col cols="12">
