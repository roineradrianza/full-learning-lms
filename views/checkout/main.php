                    ...
                    <v-col cols="12">
                        <v-row>
                            ...
                            <template v-if="info.payment_method == 'Zelle'">
                                <?php echo new Template('checkout/payments/zelle') ?>
                            </template>

                            <template v-else-if="info.payment_method == 'Bank Transfer(Bs)'">
                                <?php echo new Template('checkout/payments/bs-bank-transfer') ?>
                            </template>

                            <template v-else-if="info.payment_method == 'PagoMovil'">
                                <?php echo new Template('checkout/payments/pagomovil') ?>
                            </template>
                        </v-row>
                    </v-col>
                </v-row>
