<style type="text/css">
    @page {
      margin: 2.5%;
      background-image: url('<?php echo SITE_URL; ?>/public/img/certificado-bg.jpg');
  ...
  <div class="container">
    <header>
      <div style="width:100%" align="right">
          <img src="<?php echo SITE_URL; ?>/public/img/logo.jpg" width="110px">
      </div>
    </header>
    <div style="margin-top:-40px;margin-bottom: -20px;" align="center">
      <img src="<?php echo SITE_URL; ?>/public/img/SVCC.jpg" width="150px">
    </div>
    <div style="width:100%;">
      ...
      <div style="width: 100%;">
        <div style="width:100%" align="left">
          <div align="left" style="margin-left: 10%">
            <img src="<?php echo SITE_URL; ?>/public/img/firma-josesvg.jpg" style="border-bottom: 1.7px solid black" width="140px">          
          </div>
      ...
      <div style="width: 100%;margin-top:-135px">
        <div style="width:100%" align="right">
          <div align="right" style="width:90%">
            <img src="<?php echo SITE_URL; ?>/public/img/firma-armando.jpg" style="border-bottom: 1.7px solid black" width="140px">      
          </div>
    ...
    <div style="width: 100%; margin-top:-15px">
      <h4 class="text-center" style="color:#9C9B9B;font-family:arial !important;font-size: 12pt;">
        ...
        <br>
        <span style="font-size: 14pt;">“Curso Básico de Columna 2021”</span> de la
        <br>
    ...
    <div style="width: 100%;" align="center">
      <img src="<?php echo SITE_URL; ?>/public/img/federacion-venezolana.jpg" width="60px">
    </div>
    <?php if (count(explode(' ', $data['first_name'] . ' ' . $data['last_name'])) > 3): ?>
    <div style="width:100%; margin-top: 20px;">
        <img src="<?php echo SITE_URL; ?>/public/img/hospital-san-juan-de-dios.jpg" width="300px">
    </div>
    <?php else: ?>
