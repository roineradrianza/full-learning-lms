<style type="text/css">
    @page {
      margin: 2.5%;
      background-image: url('<?php echo DIRECTORY; ?>/public/img/certificado-bg.png');
...
<body>
  <div class="container">
    ...
    <div style="margin-top:-40px;margin-bottom: -20px;" align="center">
      <img src="<?php echo DIRECTORY; ?>/public/img/SVCC.jpg" width="150px">
    </div>
    <div style="width:100%;">
      ...
      <div style="width: 100%;">
        <div style="width:100%" align="left">
          <div align="left" style="margin-left: 10%">
            <img src="<?php echo DIRECTORY; ?>/public/img/firma-josesvg.png" style="border-bottom: 1.7px solid black" width="140px">          
          </div>
      ...
      <div style="width: 100%;margin-top:-135px">
        <div style="width:100%" align="right">
          <div align="right" style="width:90%">
            <img src="<?php echo DIRECTORY; ?>/public/img/firma-armando.png" style="border-bottom: 1.7px solid black" width="140px">      
          </div>
    ...
    <div style="width: 100%;" align="center">
      <img src="<?php echo DIRECTORY; ?>/public/img/federacion-venezolana.jpg" width="60px">
    </div>
    <?php if (count(explode(' ', $data['first_name'] . ' ' . $data['last_name'])) > 3): ?>
    <div style="width:100%; margin-top: 20px;">
        <img src="<?php echo DIRECTORY; ?>/public/img/hospital-san-juan-de-dios.jpg" width="300px">
    </div>
    <?php else: ?>
