	      	...
	      	<v-row class="px-10 px-md-16 d-flex justify-center">
		      	...
		      	<v-col cols="12" md="3">
		      		<v-card :loading="loading" class="my-12 teacher-card" max-width="95%">
						    ...
						    <v-img width="50vw" height="30vw" class="align-end" src="<?php echo SITE_URL ?>/public/img/avatar/ximena.jpg" >
		      	...
		      	<v-col cols="12" md="3">
		      		<v-card :loading="loading" class="my-12 teacher-card" max-width="95%">
						    ...
						    <v-img width="50vw" height="30vw" class="align-end" src="<?php echo SITE_URL ?>/public/img/avatar/ruth.jpg" >
						    	<v-card-title class="d-block font-weight-bold card-teacher-title white--text no-word-break">
