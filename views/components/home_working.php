	      ...
	      <template v-if="1 == 2">
		      <v-row class="px-16 d-flex align-center">
		      	<v-col class="pl-16"  cols="12" md="5">
		      		<v-img src="<?php echo SITE_URL ?>/public/img/personas-escritorio.jpg" width="100%" height="30vw"></v-img>
		      	</v-col>
		      	<v-col cols="12" md="7">
		      ...
		      <v-row class="px-16 mt-12 mb-16 d-flex align-center">
		      	...
		      	<v-col class="pl-16"  cols="12" md="4">
		      		<v-img src="<?php echo SITE_URL ?>/public/img/persona-escritorio.jpg" width="100%" height="30vw"></v-img>
		      	</v-col>
	      ...
	      <v-row class="px-16 mb-16" v-if="1 == 2">
	      	...
	      	<v-col cols="12" md="4">
	      		<v-img src="<?php echo SITE_URL ?>/public/img/certificado-plantilla.jpg"></v-img>
