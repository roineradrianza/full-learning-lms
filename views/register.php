    ...
    <v-col class="px-md-16 pt-16 white my-12 rounded-xl register-container" cols="8" offset="2" v-else>
        ...
        <v-row class="d-flex justify-center pr-md-10">
            <v-btn class="ma-2 white--text padding- py-6" @click="googleSignIn">
                <v-img class="myGoogleButton" src="<?php echo SITE_URL ?>/public/img/google-logo.png" width="1vw">
                </v-img>
            </v-btn>
                    ...
                    <v-row class="px-10 d-flex align-center">
                        ...
                        <v-col cols="12" md="4">
                            <v-btn class="white--text secondary font-weight-bold rounded-pill mb-6 mt-4 py-6"
                                @click="save" :disabled="!valid" :loading="save_loading" block>Registrarse</v-btn>
                        </v-col>
                    </v-row>
                </v-col>
